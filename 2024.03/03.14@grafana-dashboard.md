    ...
    },
    {
      ...
      "styles": [
        ...
        },
        {
          ...
          "linkTargetBlank": false,
          "linkTooltip": "Drill down",
          "linkUrl": "/d/a87fb0d919ec0ea5f6543124e16c42a5/k8s-resources-workload?var-datasource=$datasource&var-cluster=$cluster&var-namespace=$namespace&var-workload=$__cell&var-type=$__cell_2",
          "pattern": "workload",
          "thresholds": [],
          "type": "number",
          "unit": "short"
    ...
    },
    {
      ...
      "styles": [
        ...
        },
        {
          ...
          "linkTargetBlank": false,
          "linkTooltip": "Drill down to pods",
          "linkUrl": "/d/a87fb0d919ec0ea5f6543124e16c42a5/k8s-resources-workload?var-datasource=$datasource&var-cluster=$cluster&var-namespace=$namespace&var-workload=$__cell&var-type=$type",
          "pattern": "workload",
          "thresholds": [],
          "type": "number",
          "unit": "short"
...
...
```
- [[02.19@prometheus#grafana]]
- monitoring namespace에 존재하는 prometheus에서 data fetch를 위해 변경
- admin dashboard로 변경
...
- 42-morning-glory와 똑같은 방식으로 namespace 변경
...
- 드롭다운 없이 templating을 할 수 있는가?(드롭다운을 숨길 수 있는가?)
- workload(pod) 링크를 어떻게 설정할 것인가? 되돌아 올 수 있는가?
- 노드 단위 쿼리 조사
- 전체 pod의 개수 등 전체 관점에서 필요한 정보가 무엇이 있는가?
- alert rules 정의
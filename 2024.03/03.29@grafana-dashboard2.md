      ...
      "targets": [
        {
          ...
          "editorMode": "code",
          "exemplar": true,
          "expr": "avg(sum by (instance, cpu) (rate(node_cpu_seconds_total{mode!~\"idle|iowait|steal\", cluster=\"\"}[$__rate_interval])))",
          "interval": "",
          "legendFormat": "Real",
          "range": true,
          "refId": "A"
        },
        {
          ...
          "editorMode": "code",
          "expr": "sum(kube_pod_container_resource_requests{resource=\"cpu\", cluster=\"\"}) / sum(machine_cpu_cores{cluster=\"\"})",
          "hide": false,
        ...
        },
        {
          ...
          "editorMode": "code",
          "expr": "sum(kube_pod_container_resource_limits{resource=\"cpu\", cluster=\"\"}) / sum(machine_cpu_cores{cluster=\"\"})",
          "hide": false,
          "legendFormat": "Limits",
          "range": true,
          "refId": "C"
      ...
      "targets": [
        {
          ...
          "editorMode": "code",
          "exemplar": true,
          "expr": "sum(node_memory_MemTotal_bytes{cluster=\"\"} - node_memory_MemAvailable_bytes{cluster=\"\"}) / sum(node_memory_MemTotal_bytes{cluster=\"\"})",
          "interval": "",
          "legendFormat": "Real",
          "range": true,
          "refId": "A"
        },
        {
          ...
          "editorMode": "code",
          "expr": "sum(kube_pod_container_resource_requests{resource=\"memory\", cluster=\"\"}) / sum(machine_memory_bytes{cluster=\"\"})",
          "hide": false,
          "legendFormat": "Requests",
          "range": true,
          "refId": "B"
        },
        {
          ...
          "editorMode": "code",
          "expr": "sum(kube_pod_container_resource_limits{resource=\"memory\", cluster=\"\"}) / sum(machine_memory_bytes{cluster=\"\"})",
          "hide": false,
          "legendFormat": "Limits",
          "range": true,
          "refId": "C"
    ...
    },
    {
      ...
      "targets": [
        ...
        },
        {
          ...
          "expr": "sum(kube_pod_status_phase{phase=\"Running\", cluster=\"\"})",
          "interval": "",
        ...
        },
        {
          ...
          "expr": "sum(kube_service_info{cluster=\"\"})",
          "interval": "",
        ...
        },
        {
          ...
          "expr": "sum(kube_ingress_info{cluster=\"\"})",
          "interval": "",
        ...
        },
        {
          ...
          "expr": "sum(kube_deployment_labels{cluster=\"\"})",
          "interval": "",
        ...
        },
        {
          ...
          "expr": "sum(kube_statefulset_labels{cluster=\"\"})",
          "interval": "",
        ...
        },
        {
          ...
          "expr": "sum(kube_daemonset_labels{cluster=\"\"})",
          "interval": "",
        ...
        },
        {
          ...
          "expr": "sum(kube_persistentvolumeclaim_info{cluster=\"\"})",
          "interval": "",
        ...
        },
        {
          ...
          "expr": "sum(kube_hpa_labels{cluster=\"\"})",
          "interval": "",
        ...
        },
        {
          ...
          "expr": "sum(kube_configmap_info{cluster=\"\"})",
          "interval": "",
        ...
        },
        {
          ...
          "expr": "sum(kube_secret_info{cluster=\"\"})",
          "interval": "",
        ...
        },
        {
          ...
          "expr": "sum(kube_networkpolicy_labels{cluster=\"\"})",
          "interval": "",
        ...
        },
        {
          ...
          "exemplar": true,
          "expr": "count(count by (node) (kube_node_info{cluster=\"\"}))",
          "hide": false,
          "interval": "",
          "legendFormat": "Nodes",
          "refId": "N"
      ...
      "targets": [
        {
          ...
          "expr": "count(kube_namespace_created{cluster=\"\"})",
          "interval": "",
          "legendFormat": "",
          "refId": "A"
        }
      ...
      "targets": [
        {
          ...
          "editorMode": "code",
          "exemplar": true,
          "expr": "sum(node_memory_MemTotal_bytes - node_memory_MemAvailable_bytes{cluster=\"\"}) / sum(node_memory_MemTotal_bytes{cluster=\"\"})",
          "interval": "",
                ...
                "value": [
                  {
                    ...
                    "url": "/d/85a562078cdf77779eaa1add43ccec1e/pod?var-namespace=${__data.fields[1]}"
                  }
                ]
              },
              {
